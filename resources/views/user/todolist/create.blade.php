                                            ...
                                            <div class="col-md-8 col-md-offset-8">
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <form method="POST" action="{{ route('user.todolist.index') }}" role="form">
                                                            @csrf

                                                            <div class="form-group col-md-12">
                                                                <div class="col-md-6">
                                                                    <label class="control-label">Name</label>
                                                                    <input type="text" name="name" required class="form-control" placeholder="activity: breakfast, take a bath, etc..">
                                                                </div>
