                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 text-center mx-auto">
                            ...
                            <p class="text-lead text-white">Di aplikasi berbasis web administrasi digital <b>Keluarga Manurip</b></p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <form method="POST" action="{{ route('register') }}" role="form text-left">
                                    ...
                                    <div class="mb-3">
                                        <input type="text" id="name" type="text"
                                            ...
                                            aria-label="Name" aria-describedby="email-addon" autofocus>
                                    ...
                                    <div class="mb-3">
                                        <input type="password" id="password-confirm" type="password"
                                            ...
                                            required placeholder="Password Confirmation" aria-label="Password"
                                            aria-describedby="password-addon" autocomplete="new-password">
                                    </div>
                                    ...
                                    <div class="form-check form-check-info text-left">
                                        ...
                                        <label class="form-check-label" for="flexCheckDefault">
                                            Saya menyetujui <a href="javascript:;"
                                                class="text-dark font-weight-bolder">Syarat dan Peraturan yang berlaku</a>
                                        </label>
                                    </div>
